  ...
  <div class="recent-card">
    <div class="card-body p-0">
      <table class="table mb-0">
        ...
        <tbody>
          <?php $__currentLoopData = \DB::table('form_responses')->orderBy('created_at','desc')->limit(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CLSUHub(05_17_25)\CLSUHub-main\resources\views/faculty/dashboard.blade.php ENDPATH**/ ?>