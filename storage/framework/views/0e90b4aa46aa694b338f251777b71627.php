...
<div class="container my-5">
  <form id="multiStepForm" method="POST" action="<?php echo e(route('form.submit')); ?>">
    <?php echo csrf_field(); ?>
          ...
          <?php $__currentLoopData = $colleges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $college): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="form-check form-check-inline">
              <input 
                ...
                type="checkbox" 
                name="colleges[]" 
                id="college_<?php echo e($college->id); ?>" 
                value="<?php echo e($college->id); ?>">
              <label class="form-check-label" for="college_<?php echo e($college->id); ?>">
                <?php echo e($college->college); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.sidenav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CLSUHub\resources\views/form.blade.php ENDPATH**/ ?>